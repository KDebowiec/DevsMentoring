        ...
        for j in range(len(lines[i])):
            ...
            if i < len(lines) - 1:
                ...
                if abs(cursor - below_num) > 128:
                    ...
                    nums.append(cursor)
                    continue
    return amount_of_contrast_number, nums


result = check_lines(numbers)

print("Mine result:", result[0])
# print(*res[1])
...
result = found_by_karol()

print("Found by Karol result:", result[0])
# print(*[numbers[col][row] for col, row in res[1]])
